...
def main():
    ...
    try:
        ...
        spawn_positions.append(carla.Transform(location=carla.Location(x=-3.7383193969726562,
                                               ...
                                               rotation=carla.Rotation(yaw=105,
                                                                       roll=0,
                                                                       pitch=0,
                                                                       ),
                                               )
        ...
        spawn_positions.append(carla.Transform(location=carla.Location(x=-39.32744598388672,
                                                                       y=0.4153022766113281,
                                                                       z=0.5,
                                                                       ),
                                               rotation=carla.Rotation(yaw=17,
                                                                       roll=0,
                                                                       pitch=0,
                                                                       ),
                                               )
