...
def main():
    ...
    try:
        ...
        for i in range(num_runs):
            ...
            transform = world.get_map().get_spawn_points()[9]
            ...
            os.makedirs(f"_out/sequences/{current_time}/{i}")
            ...
            with CarlaSyncMode(world, camera, fps=30) as synchronizer:
                ...
                while True:
                    ...
                    image.save_to_disk(path=f'_out/sequences/{current_time}/{i}/{tick}.png')
                    tick += 1
                    if tick > len_run-1:
                        break
                    #if tick % 10 == 0:
